...
class GraphNet:
    def __init__(self,
        ...
        self.model_backward = MLP(output_size=int(nNodes),
                                  n_nodes=nNodes,
                                  n_hidden=nHidden,
                                  n_clusters=n_clusters,
                                  n_layers=nLayers,
...
def compare_results_small_graphs(filename,
    ...
    with open(filename, 'w') as file:
        ...
        for N in tqdm(range(min_N, max_N + 1), desc='Iterating over N'):
            ...
            net = GraphNet(nNodes=adjacency_matrix.size()[0], a=a, b=b, A_alpha=A_alpha,
...
if __name__ == '__main__':
    ...
    net2 = GraphNet(nNodes=adjacency_matrix.size()[0], a=a, b=b, A_alpha=A_alpha, using_backward_model=True)
    net2.save()
    net2.load_forward()
    # net2.load_backward()
